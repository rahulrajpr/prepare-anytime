...
**SparkSession Definition:** The unified entry point for Spark fun# Spark Configuration & Deployment - Interview Q&A
...
**Dynamic Allocation Definition:** Feature that automatically scales the number of executors up or down based on workload requirements.
...
- Resource quotas and limits are enforced at the container level  
- Pod lifecycle is managed by the Kubernetes controller  
